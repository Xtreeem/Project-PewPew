...
namespace Project_PewPew
{
    static class GameObjectManager
    {
        ...
        /// </summary>
        /// <param name="Object">The object being tested</param>
        private static void AddNewObjects(GameObject Object)
        {
            MainObjects.Add(Object);                        //Adds the item to the main Object list
            if (Object is Projectile)                   //Checks to see if the Object is a projectile
                Projectiles.Add(Object as Projectile);  //Adds it to the projectile list if needed
        }
